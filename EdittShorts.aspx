<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EdittShorts.aspx.cs" Inherits="EdittShorts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    <div class="container-fluid">
            ...
            <div class="col-md-6 col-md-offset-3">
                <asp:FormView ID="fv" runat="server" DataSourceID="SqlDataSource1" DefaultMode="ReadOnly" CssClass="max-width">
                    <ItemTemplate>
                        ...
                        <asp:TextBox runat="server" CssClass="form-control margin-bottom" ID="tbSize" MaxLength="7" Text='<%# Eval("size") %>'></asp:TextBox>
        ...
        <asp:SqlDataSource
            ...
            SelectCommand="SELECT * FROM [shorts] WHERE ([shortsId] = @id)">
            <SelectParameters>
                <asp:SessionParameter SessionField="shorts_id" Name="id"></asp:SessionParameter>
            </SelectParameters>
        </asp:SqlDataSource>
    </div> <!-- container-fluid -->
</asp:Content>
