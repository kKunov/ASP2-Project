<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddShorts.aspx.cs" Inherits="AddShorts" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <asp:TextBox runat="server" CssClass="form-control margin-bottom" ID="tbSize" MaxLength="7" ></asp:TextBox>
